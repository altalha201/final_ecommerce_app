...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    Get.find<UserProfileController>().getProfileData(false);
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<UserProfileController>(builder: (profileController) {
      if (profileController.getProfileInProgress) {
                ...
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      enabled: false,
                      initialValue:
                          CacheController.profileData?.shippingAddress,
  ...
  void updateName() {
    _firstNameET.text = CacheController.profileData?.firstName ?? "";
    _lastNameET.text = CacheController.profileData?.lastName ?? "";
